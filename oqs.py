...
def _load_shared_obj(name):
    ...
    print("Call load shared function")
...
print("2 - call to liboqs library to OQS_init")
...
class MechanismNotSupportedError(Exception):
    ...
    def __init__(self, alg_name):
        print("Call init function MechanismNotSupportedError")
        """
...
class MechanismNotEnabledError(MechanismNotSupportedError):
    ...
    def __init__(self, alg_name):
        print("Call init function MechanismNotEnabledError")
        """
        :param alg_name: requested algorithm name.
        """
        self.alg_name = alg_name
...
class KeyEncapsulation(ct.Structure):
    ...
    def __init__(self, alg_name, secret_key=None):
        ...
        print("Call init function keyencapsulation")
    ...
    def __enter__(self):
        print("Call enter function keyencapsulation")
        return self

    def __exit__(self, ctx_type, ctx_value, ctx_traceback):
        print("Call exit function keyencapsulation")
        self.free()

    def generate_keypair(self):
        print("Call generate keypair function keyencapsulation")
        ...
        print(self._kem.contents.length_public_key)
        print(self._kem.contents.length_secret_key)
        ...
        #resevar suficiente memoria para la clave publica y la privada
        #self._kem="holA"
        #public_key=ct.create_string_buffer(10)
        #self.secret_key = ct.create_string_buffer(10)
    ...
    def export_secret_key(self):
        print("Call export secret key function keyencapsulation")

        """Exports the secret key."""
        return bytes(self.secret_key)

    def encap_secret(self, public_key):
        print("Call encap secret function keyencapsulation")
       ...
       # ciphertext = ct.create_string_buffer(12)

       # shared_secret = ct.create_string_buffer(13)

        #my_public_key = "ndddddddddddddddddddddddddswerwerwerwerw';w'er;w"
    ...
    def decap_secret(self, ciphertext):
        print("Call decap secret function keyencapsulation")
        ...
        #my_ciphertext = ct.create_string_buffer(ciphertext,len(ciphertext)-10)
    ...
    def free(self):
        print("Call free function keyencapsulation")
    ...
    def __repr__(self):
        print("Call repr function keyencapsulation")

        return "Key encapsulation mechanism: " + self._kem.contents.method_name.decode()

print("3 - initialize values for kem")
...
print("4 - identify kem alg / is kem enabled")
...
def get_enabled_KEM_mechanisms():
    print("Call get enabled kem mechanisms")
...
def get_supported_KEM_mechanisms():
    print("Call get supported kem mechanisms")
...
class Signature(ct.Structure):
    ...
    def __init__(self, alg_name, secret_key=None):
        print("Call init Signature class")
    ...
    def __enter__(self):
        print("Call enter Signature class")
        return self

    def __exit__(self, ctx_type, ctx_value, ctx_traceback):
        print("Call exit Signature class")

        self.free()

    def generate_keypair(self):
        print("Call generate keypair Signature class")
    ...
    def export_secret_key(self):
        print("Call export secret key Signature class")

        """Exports the secret key."""
        return bytes(self.secret_key)

    def sign(self, message):
        print("Call sign Signature class")
    ...
    def verify(self, message, signature, public_key):
        print("Call verify Signature class")
    ...
    def free(self):
        print("Call free Signature class")
    ...
    def __repr__(self):
        print("Call repr Signature class")

        return "Signature mechanism: " + self._sig.contents.method_name.decode()

print("5 - initialize values for sig")
...
print("6 - identify sig alg / is sig enabled ")
...
def get_supported_sig_mechanisms():
    print("Call get supported sig mechanisms")
